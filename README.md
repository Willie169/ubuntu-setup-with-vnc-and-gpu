...
* Sufficient storage: (calculated on Kubuntu 24.04.3)
  ...
  * Plus [`install-tools-first.sh`](install-tools-first.sh): approximately 69.3 GB.
  * Plus [`install-tools-second.sh`](install-tools-second.sh): approximately 70.0 GB.
