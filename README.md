...
locally in `~`, http-server, OpenCodex, Codex, Lazygit, DNSCrypt-Proxy, Homebrew, Filelight, Glow, bat, fd, dust, fzf, Delta, Tennis, ripgrep (rg), starship, Yazi, zoxide, eza, Miniforge, pipx, uv, Poetry, MarkItDown, procs, tldr, broot, bottom (btm), hyperfine, nnn, xplr, lsd, Dangerzone, 
