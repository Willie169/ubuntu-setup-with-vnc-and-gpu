...
<li>Setup RustDesk. To use it with Tailscale, click three dots besides ID to enter <code>Settings</code>, click <code>Security</code>, click <code>Unlock security settings</code>, enter your password, and check <code>Enable direct IP access</code>, and click <code>Account > Login</code>, and login. To use Android RustDesk app with Tailscale, go to <code>Settings</code> and toggle on <code>Direct IP access</code>, and click <code>Login</code> under <code>Account</code> and login to the same account.</li>
