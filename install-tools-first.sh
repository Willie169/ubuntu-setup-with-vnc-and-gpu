...
sudo apt install aria2 clang-uml clinfo codeblocks* fcitx5 fcitx5-* fdroidserver flatpak libreoffice msr-tools obs-studio ocl-icd-opencl-dev opencl-headers openjdk-8-jdk openjdk-17-jdk qbittorrent testdisk torbrowser-launcher update-manager-core vim-gtk3 wl-clipboard -y
