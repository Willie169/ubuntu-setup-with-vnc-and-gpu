...
BREW='bat bottom broot dust fd ffmpeg-full fzf git-delta lazygit procs resvg ripgrep sevenzip vgmstream yazi yq zoxide'
CASK='altersend'
if [ "$TEST" -eq 0 ]; then
  # shellcheck disable=2086
