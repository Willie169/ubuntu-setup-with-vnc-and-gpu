...
locally in `~`, http-server, LintHTML, OpenCodex, Codex, Lazygit, DNSCrypt-Proxy, Homebrew, Filelight, Glow, bat, fd, dust, fzf, Delta, Tennis, ripgrep (rg), starship, Yazi, zoxide, eza, Miniforge, pipx, uv, yt-dlp with yt-dlp-ejs, Poetry, MarkItDown, procs, tldr, Apktool, broot, bottom (btm), hyperfine, nnn, xplr, lsd, Dangerzone, 
