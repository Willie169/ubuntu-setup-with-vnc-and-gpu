...
* Sufficient storage: (calculated on Kubuntu 24.04.3)
  ...
  * Plus [`install-tools-first.sh`](install-tools-first.sh): approximately 64.5 GB.
  * Plus [`install-tools-second.sh`](install-tools-second.sh): approximately 65.2 GB.
