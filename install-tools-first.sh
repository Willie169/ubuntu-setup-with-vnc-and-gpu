...
sudo DEBIAN_FRONTEND=noninteractive apt install apparmor-utils clinfo fcitx5 fcitx5-* flatpak language-pack-gnome-en network-manager pipewire pipewire-audio-client-libraries snapd ufw unattended-upgrades wireplumber -y -o Dpkg::Options::="--force-confnew"
rm -f .bashrc
mkdir ~/.bashrc.d
