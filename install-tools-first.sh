...
sudo apt install apparmor-utils aria2 clang-uml clinfo codeblocks* fcitx5 fcitx5-* fdroidserver flatpak libreoffice msr-tools obs-studio ocl-icd-opencl-dev opencl-headers openjdk-8-jdk openjdk-17-jdk qbittorrent testdisk torbrowser-launcher update-manager-core vim-gtk3 wl-clipboard -y
...
cd bin
echo y | ./sdkmanager "build-tools;30.0.3" "build-tools;36.1.0" "emulator" "ndk;29.0.14206865" "platform-tools" "platforms;android-33" "platforms;android-36" "sources;android-33" "sources;android-36"
