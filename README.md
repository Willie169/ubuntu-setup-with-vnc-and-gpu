...
* Sufficient storage: (calculated on Kubuntu 24.04.3)
  ...
  * Plus [`install-tools-first.sh`](install-tools-first.sh): approximately 63.7 GB.
  * Plus [`install-tools-second.sh`](install-tools-second.sh): approximately 64.4 GB.
