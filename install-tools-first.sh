...
BREW='bat bottom brogue broot dust fd ffmpeg fzf git-delta hugo lazygit procs resvg ripgrep sevenzip vgmstream yazi yq zoxide'
if [ "$TEST" -eq 0 ]; then
  # shellcheck disable=2086
