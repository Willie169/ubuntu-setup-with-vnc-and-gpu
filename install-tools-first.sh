...
[ "$TEST" -eq 0 ] && npm i -g --allow-scripts=opencode-ai bash-language-server deno dockerfile-language-server-nodejs http-server neovim opencode-ai pyright @linthtml/linthtml @openai/codex
