...
locally in `~`, http-server, LintHTML, OpenCode, Codex, Lazygit, DNSCrypt-Proxy, Homebrew, Filelight, Glow, bat, fd, dust, fzf, Delta, Tennis, ripgrep (rg), starship, Yazi, zoxide, eza, Miniforge, pipx, uv, yt-dlp with yt-dlp-ejs, Poetry, MarkItDown, procs, tldr, xmljson, JADX, Apktool, bin, Ventoy (in `~/ventoy`), broot, bottom (btm), hyperfine, xplr, lsd, Dangerzone, 
